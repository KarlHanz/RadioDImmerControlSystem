void printDisplay() {
  ...
  switch (stateCode) {
    ...
    case 30: //код принят от исполнительного блока
      sts.setText("NO TACHO");
      break;

    case 40: //код принят от исполнительного блока
      sts.setText("NO DIMM");
      break;

    case 50: //код принят от исполнительного блока
      sts.setText("NO RELAY");
      break;

    case 60: //код принят от исполнительного блока
      sts.setText("OVERHEAT");
      break;

    case 70: //код принят от исполнительного блока
