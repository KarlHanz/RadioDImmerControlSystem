...
int telemetry_data[6]; // массив принятых данных
...
uint32_t errorCode;  //принимаем цифровой код ошибки (30,40,50,60,70)
uint32_t stateCode; //для отображения на дисплее кодов статуса и ошибок
